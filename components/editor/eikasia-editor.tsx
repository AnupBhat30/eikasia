...
function EikasiaEditorShell() {
  ...
  return (
    <div className="app-shell relative min-h-screen overflow-hidden bg-[var(--background)] text-[var(--text-primary)]">
      <EditorSvgDefs />
      ...
      <div className="relative flex h-screen flex-col">
        <header className="border-b border-[var(--border)] bg-[rgba(10,10,10,0.88)] backdrop-blur-xl">
          <div className="grid min-h-20 grid-cols-1 items-center gap-3 px-3 py-3 sm:grid-cols-[1fr_auto] sm:gap-4 sm:px-4 sm:py-4 lg:grid-cols-[1fr_auto_1fr] xl:px-6">
            ...
            <div className="flex items-center justify-center gap-2 sm:gap-3">
              <Button variant="amber" onClick={requestUpload}>
        ...
        <div className="grid min-h-0 flex-1 grid-cols-[72px_minmax(0,1fr)] sm:grid-cols-[84px_minmax(0,1fr)] lg:grid-cols-[220px_minmax(0,1fr)_320px] xl:grid-cols-[260px_minmax(0,1fr)_320px]">
          <aside className="min-h-0 overflow-hidden border-r border-[var(--border)] bg-[rgba(20,20,20,0.96)]">
          ...
          <main className="relative min-w-0 bg-[radial-gradient(circle_at_top,rgba(245,158,11,0.06),transparent_22%),radial-gradient(circle_at_bottom,rgba(255,255,255,0.03),transparent_18%),#0f0f0f]">
            <CanvasStage
              ref={stageRef}
      ...
      {inspectorOpen ? (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          />
          <aside className="absolute right-0 top-0 h-full w-[min(92vw,360px)] overflow-hidden border-l border-[var(--border)] bg-[rgba(17,17,17,0.98)] shadow-[0_20px_60px_rgba(0,0,0,0.55)]">
