...
const LOOK_PRESETS: Record<string, LookPreset> = {
  ...
  "colorplus-200": {
    ...
    grain: { intensity: 20, size: 28, opacity: 0.14, blendMode: "soft-light" },
  },
  "cinestill-800t": {
    filterIntensity: 92,
    adjustments: {
  ...
  "la-la-land": {
    ...
    grain: { intensity: 24, size: 28, opacity: 0.16, blendMode: "overlay" },
  },
  "grand-budapest": {
    filterIntensity: 82,
    adjustments: {
    ...
    grain: { intensity: 16, size: 20, opacity: 0.12, blendMode: "soft-light" },
  },
  "miami-vice": {
    filterIntensity: 88,
    adjustments: {
    ...
    grain: { intensity: 28, size: 32, opacity: 0.18, blendMode: "overlay" },
  },
  "amber-glow": {
    filterIntensity: 85,
    adjustments: {
    ...
    grain: { intensity: 16, size: 22, opacity: 0.12, blendMode: "soft-light" },
  },
  "chroma-pop": {
    filterIntensity: 90,
    adjustments: {
  ...
  "california-dream": {
    ...
    grain: { intensity: 22, size: 24, opacity: 0.14, blendMode: "soft-light" },
  },
  "nordic-chill": {
    filterIntensity: 86,
    adjustments: {
    ...
    grain: { intensity: 24, size: 28, opacity: 0.15, blendMode: "soft-light" },
  },
  "sunset-glow": {
    filterIntensity: 88,
    adjustments: {
    ...
    grain: { intensity: 20, size: 24, opacity: 0.15, blendMode: "soft-light" },
  },
  "rose-gold": {
    filterIntensity: 85,
    adjustments: {
  ...
  "pastel-dream": {
    ...
    grain: { intensity: 14, size: 18, opacity: 0.10, blendMode: "soft-light" },
  },
  "royal-blue": {
    filterIntensity: 90,
    adjustments: {
    ...
    grain: { intensity: 22, size: 26, opacity: 0.14, blendMode: "soft-light" },
  },
  "vintage-teal": {
    filterIntensity: 85,
    adjustments: {
    ...
    grain: { intensity: 20, size: 22, opacity: 0.14, blendMode: "soft-light" },
  },
  "desert-glam": {
    filterIntensity: 86,
    adjustments: {
    ...
    grain: { intensity: 18, size: 24, opacity: 0.13, blendMode: "soft-light" },
  },
  "euphoria": {
    filterIntensity: 90,
    adjustments: {
    ...
    grain: { intensity: 24, size: 30, opacity: 0.16, blendMode: "soft-light" },
  },
  "tokyo-drift": {
    filterIntensity: 90,
    adjustments: {
    ...
    grain: { intensity: 28, size: 36, opacity: 0.18, blendMode: "overlay" },
  },
};
...
const ANALOG_FILM_LOOKS_BASE: LookDefinitionInput[] = [
  ...
  },
  {
    ...
    category: "analog",
    cssFilter:
      "brightness(1.00) contrast(1.02) saturate(1.03) hue-rotate(-1deg) sepia(0.05)",
    matrix:
      "1.02 0.01 0.00 0 0.00  0.00 1.00 0.01 0 0.00  0.00 0.01 0.96 0 0.00  0 0 0 1 0",
    thumbnail:
...
export const COLORFUL_LOOKS_BASE: LookDefinitionInput[] = [
  {
    id: "barbie-core",
    name: "Barbie Core",
    summary: "Dreamy pink pastels and bright bubblegum tones.",
    category: "colorful",
    cssFilter: "brightness(1.05) contrast(0.98) saturate(1.25) hue-rotate(-6deg) sepia(0.04)",
    matrix: "1.08 0.05 -0.02 0 0.04  -0.02 1.06 0.04 0 0.01  0.01 -0.03 1.08 0 0.02  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 30% 24%, rgba(255,192,203,0.92), transparent 42%), linear-gradient(135deg, rgba(231,76,143,0.95), rgba(255,150,186,0.9) 52%, rgba(255,220,180,0.92))",
  },
  {
    id: "la-la-land",
    name: "La La Land",
    summary: "Vibrant twilight sunset yellows, oranges, and deep warm tones.",
    category: "colorful",
    cssFilter: "brightness(1.03) contrast(1.08) saturate(1.30) hue-rotate(-12deg) sepia(0.08)",
    matrix: "1.06 0.04 -0.01 0 0.02  0.02 1.02 0.06 0 0.01  -0.03 0.08 1.12 0 -0.01  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 28% 24%, rgba(255,220,150,0.9), transparent 38%), linear-gradient(135deg, rgba(20,50,120,0.98), rgba(240,120,60,0.96) 52%, rgba(255,190,80,0.98))",
  },
  {
    id: "grand-budapest",
    name: "Grand Budapest",
    summary: "Soft symmetrical pastel pinks and creams from the Wes Anderson classic.",
    category: "colorful",
    cssFilter: "brightness(1.06) contrast(0.92) saturate(1.08) hue-rotate(-4deg) sepia(0.12)",
    matrix: "1.04 0.02 0.00 0 0.02  0.00 1.01 0.03 0 0.01  -0.01 0.01 0.94 0 0.02  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 26% 22%, rgba(252,210,220,0.88), transparent 40%), linear-gradient(135deg, rgba(220,150,170,0.92), rgba(240,210,180,0.9) 52%, rgba(255,230,190,0.94))",
  },
  {
    id: "miami-vice",
    name: "Miami Vice",
    summary: "Saturated neon pop with hot magenta highlights and deep turquoise shadows.",
    category: "colorful",
    cssFilter: "brightness(1.02) contrast(1.12) saturate(1.35) hue-rotate(-15deg) sepia(0.02)",
    matrix: "1.02 0.02 0.06 0 -0.01  0.00 0.96 0.08 0 -0.01  -0.04 0.04 1.10 0 -0.01  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 32% 22%, rgba(255,60,180,0.68), transparent 34%), linear-gradient(135deg, rgba(10,120,130,0.98), rgba(255,20,147,0.96) 54%, rgba(0,206,209,0.94))",
  },
  {
    id: "euphoria",
    name: "Euphoria",
    summary: "Cinematic dreaminess: deep lavender-blue tints and saturated pink highlights.",
    category: "colorful",
    cssFilter: "brightness(0.98) contrast(1.10) saturate(1.24) hue-rotate(-8deg) sepia(0.04)",
    matrix: "1.04 0.00 0.04 0 -0.01  -0.02 1.02 0.06 0 0.00  -0.04 0.02 1.14 0 -0.01  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 30% 24%, rgba(255,180,220,0.85), transparent 40%), linear-gradient(135deg, rgba(30,16,80,0.95), rgba(160,80,180,0.9) 52%, rgba(80,180,240,0.88))",
  },
  {
    id: "tokyo-drift",
    name: "Tokyo Drift",
    summary: "Cyberpunk vibe: deep midnight blues and vibrant cyan/orange split-toning.",
    category: "colorful",
    cssFilter: "brightness(0.96) contrast(1.18) saturate(1.28) hue-rotate(-12deg) sepia(0.02)",
    matrix: "0.98 0.04 0.06 0 -0.02  0.02 0.98 0.08 0 -0.01  -0.06 0.06 1.16 0 -0.02  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 28% 22%, rgba(0,255,255,0.7), transparent 38%), linear-gradient(135deg, rgba(8,12,36,0.98), rgba(255,68,0,0.94) 54%, rgba(0,200,220,0.96))",
  },
];

export const CHROMA_LOOKS_BASE: LookDefinitionInput[] = [
  {
    id: "chroma-golden-hour",
    name: "Golden Hour",
    summary: "Insta-glow: rich warm golden tones, soft peach highlights, clean skies.",
    category: "chroma",
    cssFilter: "brightness(1.04) contrast(1.02) saturate(1.15) sepia(0.12)",
    matrix: "1.06 0.02 -0.01 0 0.02  0.01 1.02 0.01 0 0.01  -0.02 0.01 0.96 0 0.00  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 28% 22%, rgba(255,235,180,0.94), transparent 42%), linear-gradient(135deg, rgba(235,140,60,0.95), rgba(255,185,110,0.92) 50%, rgba(255,220,150,0.96))",
  },
  {
    id: "amber-glow",
    name: "Amber Glow",
    summary: "Honey-warm tones, cozy ambient contrast, and rich warm shadows.",
    category: "chroma",
    cssFilter: "brightness(1.02) contrast(1.04) saturate(1.10) sepia(0.18)",
    matrix: "1.04 0.03 -0.01 0 0.01  0.02 1.01 0.02 0 0.01  -0.03 0.02 0.94 0 0.00  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 30% 24%, rgba(255,210,130,0.92), transparent 40%), linear-gradient(135deg, rgba(175,90,30,0.96), rgba(220,140,60,0.94) 52%, rgba(250,195,110,0.96))",
  },
  {
    id: "chroma-pop",
    name: "Chroma Pop",
    summary: "Vibrant and clean: punchy saturation, rich greens, and bright reds.",
    category: "chroma",
    cssFilter: "brightness(1.01) contrast(1.08) saturate(1.22)",
    matrix: "1.02 0.01 0.01 0 0.00  0.01 1.03 0.01 0 0.00  0.01 0.01 1.03 0 0.00  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 26% 20%, rgba(255,255,255,0.7), transparent 36%), linear-gradient(135deg, rgba(220,20,60,0.95), rgba(50,205,50,0.92) 50%, rgba(30,144,255,0.95))",
  },
  {
    id: "california-dream",
    name: "California Dream",
    summary: "Warm retro sunshine: faded contrast, warm highlights, and teal skies.",
    category: "chroma",
    cssFilter: "brightness(1.05) contrast(0.96) saturate(1.12) sepia(0.10)",
    matrix: "1.05 0.01 -0.01 0 0.02  0.00 1.02 0.01 0 0.01  -0.04 0.02 0.98 0 0.00  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 28% 22%, rgba(255,240,200,0.92), transparent 42%), linear-gradient(135deg, rgba(244,164,96,0.95), rgba(240,230,140,0.9) 52%, rgba(175,238,238,0.94))",
  },
  {
    id: "nordic-chill",
    name: "Nordic Chill",
    summary: "Clean minimalistic cold tones: crisp whites and deep blue sky purity.",
    category: "chroma",
    cssFilter: "brightness(1.03) contrast(1.05) saturate(0.95) hue-rotate(4deg)",
    matrix: "0.98 0.01 0.01 0 0.00  0.01 0.98 0.01 0 0.00  0.02 0.02 1.05 0 0.01  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 24% 18%, rgba(255,255,255,0.88), transparent 34%), linear-gradient(135deg, rgba(70,130,180,0.96), rgba(220,225,235,0.9) 50%, rgba(240,248,255,0.98))",
  },
  {
    id: "sunset-glow",
    name: "Sunset Glow",
    summary: "Warm, radiant sunset tones with pinkish highlights and rich gold gradients.",
    category: "chroma",
    cssFilter: "brightness(1.03) contrast(1.05) saturate(1.18) sepia(0.08)",
    matrix: "1.06 0.02 0.00 0 0.02  0.00 1.01 0.02 0 0.01  -0.02 0.00 0.96 0 0.00  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 30% 24%, rgba(255,182,193,0.95), transparent 44%), linear-gradient(135deg, rgba(210,105,30,0.96), rgba(255,127,80,0.94) 52%, rgba(255,215,0,0.96))",
  },
  {
    id: "rose-gold",
    name: "Rose Gold",
    summary: "Premium rose-gold tints, soft peachy highlights, and warm rich shadows.",
    category: "chroma",
    cssFilter: "brightness(1.04) contrast(0.98) saturate(1.10) sepia(0.06)",
    matrix: "1.08 0.01 0.01 0 0.03  0.00 1.02 0.02 0 0.01  0.00 0.00 0.98 0 0.01  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 28% 22%, rgba(255,228,225,0.94), transparent 40%), linear-gradient(135deg, rgba(188,143,143,0.95), rgba(255,182,193,0.9) 52%, rgba(255,218,185,0.92))",
  },
  {
    id: "lush-greens",
    name: "Lush Greens",
    summary: "Deep, vivid forest greens and popped foliage with organic warmth.",
    category: "chroma",
    cssFilter: "brightness(1.01) contrast(1.06) saturate(1.15)",
    matrix: "1.00 0.00 0.00 0 0.00  0.01 1.05 0.01 0 0.01  0.00 0.00 0.98 0 0.00  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 26% 20%, rgba(255,255,255,0.7), transparent 36%), linear-gradient(135deg, rgba(34,139,34,0.96), rgba(46,139,87,0.92) 52%, rgba(107,142,35,0.94))",
  },
  {
    id: "pastel-dream",
    name: "Pastel Dream",
    summary: "Airy, high-key bright and clean pastel tones with softened contrast.",
    category: "chroma",
    cssFilter: "brightness(1.08) contrast(0.92) saturate(1.12) sepia(0.04)",
    matrix: "1.03 0.01 0.01 0 0.01  0.00 1.01 0.02 0 0.01  0.00 0.00 0.99 0 0.01  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 30% 24%, rgba(255,240,245,0.94), transparent 42%), linear-gradient(135deg, rgba(221,160,221,0.9), rgba(176,224,230,0.9) 52%, rgba(255,239,213,0.94))",
  },
  {
    id: "royal-blue",
    name: "Royal Blue",
    summary: "Deep sea and sky blue saturation, rich contrast, and natural warm highlights.",
    category: "chroma",
    cssFilter: "brightness(1.00) contrast(1.12) saturate(1.18)",
    matrix: "1.00 0.00 0.00 0 0.00  0.00 1.00 0.00 0 0.00  0.01 0.01 1.08 0 0.02  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 28% 22%, rgba(255,255,255,0.7), transparent 38%), linear-gradient(135deg, rgba(25,25,112,0.98), rgba(70,130,180,0.94) 52%, rgba(135,206,250,0.96))",
  },
  {
    id: "vintage-teal",
    name: "Vintage Teal",
    summary: "Calibrated classic retro teal/gold without turning blue skies green.",
    category: "chroma",
    cssFilter: "brightness(1.02) contrast(1.06) saturate(1.08) sepia(0.04)",
    matrix: "1.04 0.00 -0.02 0 0.02  0.00 1.02 0.00 0 0.00  -0.02 0.02 1.04 0 -0.01  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 26% 20%, rgba(255,228,196,0.9), transparent 38%), linear-gradient(135deg, rgba(0,128,128,0.98), rgba(218,165,32,0.92) 52%, rgba(175,238,238,0.94))",
  },
  {
    id: "desert-glam",
    name: "Desert Glam",
    summary: "Warm sandy highlights, high clarity, and popped desert sunset color tones.",
    category: "chroma",
    cssFilter: "brightness(1.05) contrast(1.04) saturate(1.14) sepia(0.12)",
    matrix: "1.06 0.01 -0.01 0 0.02  0.01 1.02 0.01 0 0.01  -0.03 0.01 0.95 0 0.00  0 0 0 1 0",
    thumbnail: "radial-gradient(circle at 30% 24%, rgba(255,222,173,0.92), transparent 40%), linear-gradient(135deg, rgba(205,133,63,0.96), rgba(244,164,96,0.94) 52%, rgba(255,228,181,0.96))",
  },
];
...
export const COLORFUL_LOOKS: LookDefinition[] = COLORFUL_LOOKS_BASE.map(defineLook);
export const CHROMA_LOOKS: LookDefinition[] = CHROMA_LOOKS_BASE.map(defineLook);
...
export const ASPECT_RATIO_PRESETS: AspectRatioPreset[] = [
  ...
  { id: "1:9", label: "1:9", value: 1 / 9 },
];

export function getPerspectiveForPreset(
  presetId: string,
  ...
  const R_target = preset.value;
  const widthVal = imageWidth ?? 1000;
  const heightVal = imageHeight ?? 1000;
  const R_image = widthVal / heightVal;
  const R_pct = R_target / R_image;

  let widthPct = 84;
  let heightPct = widthPct / R_pct;

  if (heightPct > 84) {
    heightPct = 84;
    widthPct = heightPct * R_pct;
  }

  const offsetX = (100 - widthPct) / 2;
  const offsetY = (100 - heightPct) / 2;

  return {
    tl: { x: offsetX, y: offsetY },
    tr: { x: offsetX + widthPct, y: offsetY },
    br: { x: offsetX + widthPct, y: offsetY + heightPct },
    bl: { x: offsetX, y: offsetY + heightPct },
  };
}
